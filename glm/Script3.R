...
modeloCaret0 <- caret::train(training0[,-c(1, 18, 62, 76)], as.factor(training0[,76]), method="glm", family=binomial(),
                             preProcess = c("center", "scale"),
                             tuneLength = 10,
                             trControl = trainControl(method = "cv"))
modelo.predict0 <- caret::predict.train(modeloCaret0, training0[,-c(1, 18, 62, 76)], type="prob")
modeloCaret1 <- caret::train(training1[,-c(1, 18, 62, 76)], as.factor(training1[,76]), method="glm", family=binomial(),
                             preProcess = c("center", "scale"),
                             tuneLength = 10,
                             trControl = trainControl(method = "cv"))
modelo.predict1 <- caret::predict.train(modeloCaret1, training1[,-c(1, 18, 62, 76)], type="prob")
modeloCaret2 <- caret::train(training2[,-c(1, 18, 62, 76)], as.factor(training2[,76]), method="glm", family=binomial(),
                             preProcess = c("center", "scale"),
                             tuneLength = 10,
                             trControl = trainControl(method = "cv"))
modelo.predict2 <- caret::predict.train(modeloCaret2, training2[,-c(1, 18, 62, 76)], type="prob")
modeloCaret3 <- caret::train(training3[,-c(1, 18, 62, 76)], as.factor(training3[,76]), method="glm", family=binomial(),
                             preProcess = c("center", "scale"),
                             tuneLength = 10,
                             trControl = trainControl(method = "cv"))
modelo.predict3 <- caret::predict.train(modeloCaret3, training3[,-c(1, 18, 62, 76)], type="prob")
