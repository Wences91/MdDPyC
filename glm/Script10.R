...
# RUS
train2 <- train
levels(train2[,75])<- c(0,1,1,1)
table(train2[,75])
prueba <- ROSE::ovun.sample(y ~., train2, method = "over")
train <- rbind(train, prueba$data[which(prueba$data[,75]==0),])



#KNN
modeloCaret0 <- caret::train(train[,-c(bbb[1:27], 75)], as.factor(train[,75]), method="knn",
