...
train <- IPF(y ~., train, s=2, nfolds=5, consensus=TRUE, p=0.02) #nfolda4
...
library(unbalanced)
?ubSMOTE
instanciasSmote <- ubSMOTE(train[,-75], factor(as.integer(I(train[,75]==0))), perc.over = 1000, perc.under = 500)
...
levels(train2[,75])<- c(0,1)
table(train2[,75])
prueba <- ROSE::ovun.sample(y ~., train2, method = "over", p=0.5)
train2 <- prueba$data
levels(train2) <- c(0,1)

train3 <- train[which(train[,75]==0|train[,75]==2),]
levels(train3[,75])<- c(0,1)
table(train3[,75])
prueba <- ROSE::ovun.sample(y ~., train3, method = "over", p=0.3)
train3 <- prueba$data
levels(train3) <- c(0,2)

train4 <- train[which(train[,75]==0|train[,75]==3),]
levels(train4[,75])<- c(0,1)
table(train4[,75])
prueba <- ROSE::ovun.sample(y ~., train4, method = "over", p=0.3)
train4 <- prueba$data
levels(train4) <- c(0,3)
...
library(caret)
#KNN
modeloCaret0 <- caret::train(train[,-c(bbb[1:28], 75)], as.factor(train[,75]), method="knn",
...
modeloCaret0 #  0.9225774  0.8795872
a <- which(predicciones[,2]==0)
